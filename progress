...
11/10/17
  
Tested photoresistor with Arduino & LED. Script: photoresistor-led.
...
Connected accelertometer with Arduino by flat ribbon cable.
  VCC -> 3.3V
  GND -> GND
  SCL -> A5
  SDA -> A4
...
Tested accelerometer for raw data. Script: accelerometer-test.
Tested accelerometer for a base. Script: accelerometer-base.
